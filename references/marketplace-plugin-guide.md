...
- **Slash Commands**: Quick CLI invocations (e.g., `/bm25-index-tool:help`)
- **Skills**: Comprehensive documentation with progressive disclosure (e.g., `/skill-bm25-index-tool`)
...
**File**: `plugins/bm25-index-tool/.claude-plugin/plugin.json`
...
**Location**: `plugins/bm25-index-tool/commands/`
...
**Adding New Commands**:
1. Create `plugins/bm25-index-tool/commands/<command>.md`
...
/bm25-index-tool:command "argument"
```

## Skills

**Location**: `plugins/bm25-index-tool/skills/bm25-index-tool/SKILL.md`
...
Or:
```
Use the skill-bm25-index-tool to help me understand this tool
```
...
1. **Update the slash command** (optional):
   - Create `plugins/bm25-index-tool/commands/<command>.md`
...
3. `plugins/bm25-index-tool/.claude-plugin/plugin.json` → `version`
...
# Check plugin
cat plugins/bm25-index-tool/.claude-plugin/plugin.json | jq '.'

# List commands
ls plugins/bm25-index-tool/commands/

# Check skill
cat plugins/bm25-index-tool/skills/bm25-index-tool/SKILL.md
```

### Test in Claude Code
1. Open your project in Claude Code
2. Try slash command: `/bm25-index-tool:help`
3. Try skill: `/skill-bm25-index-tool`
