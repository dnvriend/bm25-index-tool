...
from bm25_index_tool import __version__
...
class TelemetryConfig:
    ...
    enabled: bool = False
    service_name: str = "bm25-index-tool"
    ...
    def from_env(cls) -> TelemetryConfig:
        ...
        Environment Variables:
            ...
            OTEL_SERVICE_NAME: Service name (default: bm25-index-tool)
        ...
        return cls(
            enabled=enabled,
            service_name=os.environ.get("OTEL_SERVICE_NAME", "bm25-index-tool"),
